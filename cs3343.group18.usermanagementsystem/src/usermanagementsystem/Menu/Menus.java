...
public class Menus {
    ...
    public void printAdminHomeMenu() {
        ...
        System.out.println("11) List User Infomation");//Create User
        System.out.println("12) User Permission");//Read User Info
    ...
    public void printPermissionMenu() {
        ...
        System.out.println("1) Add Permission");//Create User
        System.out.println("2) Remove Permission");//Read User Info
        System.out.println();
    }
